CREATE DATABASE  IF NOT EXISTS `recipes_db` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `recipes_db`;
...
INSERT INTO `auth_permission` VALUES (1,'Can add log entry',1,'add_logentry'),(2,'Can change log entry',1,'change_logentry'),(3,'Can delete log entry',1,'delete_logentry'),(4,'Can add permission',2,'add_permission'),(5,'Can change permission',2,'change_permission'),(6,'Can delete permission',2,'delete_permission'),(7,'Can add group',3,'add_group'),(8,'Can change group',3,'change_group'),(9,'Can delete group',3,'delete_group'),(10,'Can add user',4,'add_user'),(11,'Can change user',4,'change_user'),(12,'Can delete user',4,'delete_user'),(13,'Can add content type',5,'add_contenttype'),(14,'Can change content type',5,'change_contenttype'),(15,'Can delete content type',5,'delete_contenttype'),(16,'Can add session',6,'add_session'),(17,'Can change session',6,'change_session'),(18,'Can delete session',6,'delete_session'),(19,'Can add sub recipes',8,'add_subrecipes'),(20,'Can change sub recipes',8,'change_subrecipes'),(21,'Can delete sub recipes',8,'delete_subrecipes'),(22,'Can add recipes',9,'add_recipes'),(23,'Can change recipes',9,'change_recipes'),(24,'Can delete recipes',9,'delete_recipes'),(25,'Can add bookmarks',10,'add_bookmarks'),(26,'Can change bookmarks',10,'change_bookmarks'),(27,'Can delete bookmarks',10,'delete_bookmarks'),(28,'Can add tags',11,'add_tags'),(29,'Can change tags',11,'change_tags'),(30,'Can delete tags',11,'delete_tags'),(31,'Can add recipes users',12,'add_recipesusers'),(32,'Can change recipes users',12,'change_recipesusers'),(33,'Can delete recipes users',12,'delete_recipesusers'),(34,'Can add recipes tags',13,'add_recipestags'),(35,'Can change recipes tags',13,'change_recipestags'),(36,'Can delete recipes tags',13,'delete_recipestags');
...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(2,'auth','permission'),(3,'auth','group'),(4,'auth','user'),(5,'contenttypes','contenttype'),(6,'sessions','session'),(7,'recipes','recipe'),(8,'recipes','subrecipes'),(9,'recipes','recipes'),(10,'recipes','bookmarks'),(11,'recipes','tags'),(12,'recipes','recipesusers'),(13,'recipes','recipestags');
...
--
-- Table structure for table `subrecipes`
--
...
CREATE TABLE `subrecipes` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`),
  KEY `SubRecipes_recipe_id_32cc9851_fk_recipes_id` (`recipe_id`),
  CONSTRAINT `SubRecipes_recipe_id_32cc9851_fk_recipes_id` FOREIGN KEY (`recipe_id`) REFERENCES `recipes` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `subrecipes`
--

LOCK TABLES `subrecipes` WRITE;
/*!40000 ALTER TABLE `subrecipes` DISABLE KEYS */;
INSERT INTO `subrecipes` VALUES (1,'Marinade','2 tb sesame oil\r\n2 tb rice vinegar\r\n2 tb brown sugar\r\n2 tb soy sauce\r\n2 garlic cloves, minced\r\n1 tb grated ginger\r\n1-2 tb sesame seeds\r\n4 green onions, sliced','',15),(2,'Glaze','1/4 cup honey\r\n1 tp sesame oil\r\n1 tp soy sauce\r\n1/2 tp grated ginger\r\n1/2 tp sesame seeds','',15);
/*!40000 ALTER TABLE `subrecipes` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-06-28  8:06:58
